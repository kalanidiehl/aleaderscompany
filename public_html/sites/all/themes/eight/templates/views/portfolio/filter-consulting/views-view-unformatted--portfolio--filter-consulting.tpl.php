...
<div class="isotop-container">
    ...
    <div class="container">
        <div class="filter-buttons mb-40">
            <a href="#" data-filter="*" class="filter-button color-4 active"><?php print t('All') ?></a>
        <?php foreach($tree_cateory as $tid => $term): ?>
            <a href="#" data-filter="<?php print '.item-'.$term->tid ?>" class="filter-button  color-4 "><?php print $term->name ?></a>
        <?php endforeach; ?>
        </div>
    </div>
    <?php endif; ?>
