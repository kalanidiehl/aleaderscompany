...
<div class="isotop-container">
    ...
    <div class="container">
        <div class="filter-buttons mb-40">
            <a href="#" data-filter="*" class="filter-button active"><?php print t('All') ?></a></li>
        <?php foreach($tree_cateory as $tid => $term): ?>
            <a href="#" data-filter="<?php print '.item-'.$term->tid ?>" class="filter-button "><?php print $term->name ?></a>
        <?php endforeach; ?>
        </div>
    </div>
    <?php endif; ?>
