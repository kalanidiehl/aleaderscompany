...
<div class="<?php print $classes; ?> media-soundcloud-<?php print $id; ?>">
  <iframe class="media-soundcloud-player" <?php print $api_id_attribute; ?> width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>"  allowfullscreen><?php print $alternative_content; ?></iframe>
</div>
